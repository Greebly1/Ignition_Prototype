...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/UltEventButton", 31)]
    public class UltEventButton : Selectable, IPointerClickHandler, ISubmitHandler
    {
        [Serializable]
        /// <summary>
        ...
        public class ButtonClickedEvent : UltEvent { }

        // Event delegates triggered on click.
        [SerializeField]
        private ButtonClickedEvent m_OnClick = new ButtonClickedEvent();

        protected UltEventButton()
        { }
